...
<body>
  ...
  <figure>
    <img src="../portfolio_images_full/architecture_kenmore_7.jpg" width="670" height="424"/>
    <figcaption>
      <p id="title">Kenmore Square Film Archive and Outdoor Theater</p>
      <p>June 2011</p>
      <p>This is a study model of the Kenmore Square project. The aim of this project is to create a cultural and community hub while preserving the subway stop that is currently occupying the site. The design includes and outdoor theatre, a film archive, and indoor theater, offices, and a special collection section that houses rare films.</p>
  </figcaption>
  </figure>
